...
interface ConfirmarActividadDialogProps {
  open: boolean
...
export function ConfirmarActividadDialog({
  open,
  onOpenChange,
  persona,
  onConfirm,
}: ConfirmarActividadDialogProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error(error.message || 'Error al confirmar actividad', { duration: 8000 })
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Confirmar Actividad</DialogTitle>
          <DialogDescription>
            Sube una imagen como evidencia de que {persona?.nombres} {persona?.apellidos} completó la actividad
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSubmit} disabled={!file || loading}>
            {loading ? 'Confirmando actividad...' : 'Confirmar Actividad'}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
